...
export function LandingPageComponent() {
  ...
  {/* Sticky Navbar */}
  <header className="absolute top-0 left-0 right-0 z-50 bg-white bg-opacity-40 dark:bg-gray-800 dark:bg-opacity-10 shadow-md border-b border-gray-300">
  <div className="container mx-auto px-4 py-6 flex justify-between items-center relative z-10">
    <div className="flex items-center space-x-2">
      ...
      <span className="text-2xl font-bold">Trust Healthcare</span>
    </div>
    ...
    >
      ...
      <main>
        <section className="container mx-auto text-center flex-grow relative z-10 " style={{ minHeight: '100vh' }}>      
        <CustomSlider>
  ...
  <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8">
    {[
      ...
      >
        ...
        <section id="contact" className="container mx-auto px-4 py-20 text-center">
          <h2 className="text-3xl font-bold mb-6">Stay Updated with Trust Healthcare</h2>
  ...
  <div className="container mx-auto px-4 text-center">
    <p>&copy; {new Date().getFullYear()} Trust Healthcare. All rights reserved.</p>
